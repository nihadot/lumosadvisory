      ...
      <div id='service-two' className="relative flex">
        <div className="flex w-full justify-between">
          <div className="w-[650px] px-5 text-justify">
            ...
            <h1 className='mt-10 text-black text-xl font-medium'>Business Transformation <br />and Performance Improvement</h1>
          ...
          <div className="flex">
            ...
            <img className='w-[510px] h-screen' src={img5} alt="Business Transformation" />
          </div>
